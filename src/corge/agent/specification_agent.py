...
class SpecificationAgent:
    ...
    def analyze_specification_gaps(
        ...
        instruction = (
            ...
            "CRITICAL:\n"
            "- The user input originates from a UI workspace called the 'canvas'. This is just the input screen, "
            ...
            "- Ignore minor implementation details or minor ambiguities (e.g., whether to create a new file or modify an existing one, "
            "file naming choices, or standard library usage). Do NOT generate semantic gaps for such non-blocking choices; "
